...
| **Replay resistance** | Single-use nonces in DB | Nonce + on-chain state |
...
- Web2: do **not** accept client-encrypted values as truth unless backed by:
  - a server-signed claim, or
  - a ZK proof of validity.
