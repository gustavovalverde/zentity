...
This folder captures notable architecture decisions for Zentity. Each ADR includes context, the decision, and consequences. Our goal is to preserve the understanding of the project growth, and capture enough insight to effectively revisit previous decisions.
