...
export interface FheEncryptDobResult extends FheCiphertextResult {
  dobInt: number;
}

export interface FheEncryptLivenessResult extends FheCiphertextResult {
  score: number;
}

export interface FheVerifyAgeResult {
  isOver18: boolean;
}

export interface FheVerifyLivenessThresholdResult {
