...
export function createDummyRegistrationRecord(): Promise<{
  ...
  return Promise.resolve({ registrationRecord, userIdentifier });
}
...
export function encryptServerLoginState(params: {
