  ...
  .query(async ({ input }) => {
    ...
    return {
      ...
      verification: {
        ...
        identityStrength: verificationModel.compliance.identity.strength,
        identityVerified: verificationModel.compliance.identity.verified,
        humanityProven: verificationModel.compliance.humanity.proven,
      },
