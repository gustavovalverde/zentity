...
export const POLICY_VERSION = "compliance-policy-2025-12-28";
export const ISSUER_ID = "zentity-attestation";
export const NATIONALITY_GROUP = "GLOBAL";
export const MIN_AGE_POLICY = 18;
