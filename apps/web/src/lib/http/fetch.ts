/**
 * JSON fetch wrapper with timeout + structured error reporting.
 *
 * Callers receive `HttpError` on non-2xx responses or unreadable JSON,
 * and `TimeoutError` when the request exceeds `timeoutMs`.
 */
