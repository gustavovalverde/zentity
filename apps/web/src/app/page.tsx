      ...
      >
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-8">
            ...
            passkey, password, or wallet authentication and key custody,
            zero-knowledge proofs, fully homomorphic encryption, and
            cryptographic commitments to verify your identity while keeping your
            information private.
          </p>
