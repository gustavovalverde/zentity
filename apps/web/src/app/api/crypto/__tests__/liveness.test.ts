...
describe('Liveness FHE API', () => {
  ...
  describe('POST /api/crypto/encrypt-liveness', () => {
    it('should return 401 when not authenticated', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/crypto/encrypt-liveness', {
        method: 'POST',
    ...
    it('should accept boundary values (0.0 and 1.0)', async () => {
      ...
      // Test score = 0.0
      const request0 = new NextRequest('http://localhost:3000/api/crypto/encrypt-liveness', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      const request1 = new NextRequest('http://localhost:3000/api/crypto/encrypt-liveness', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  describe('POST /api/crypto/verify-liveness-threshold', () => {
    it('should return 401 when not authenticated', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/crypto/verify-liveness-threshold', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
    ...
    it('should verify threshold successfully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/crypto/verify-liveness-threshold', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ ciphertext: 'encrypted-data', threshold: 0.5 }),
      });
    ...
    it('should return false when threshold not met', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/crypto/verify-liveness-threshold', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ ciphertext: 'encrypted-data', threshold: 0.9 }),
      });
